...
from studio_data.services.email_ingestion import pipeline
from studio_data.services.email_ingestion.imap_client import (
    ImapClient,
    ImapClientError,
    ImapFolderError,
)
from studio_data.services.email_ingestion.repository import (
...
from studio_data.services.email_ingestion.types import (
    AttachmentPayload,
    FolderIdentity,
    MessageHeader,
)
