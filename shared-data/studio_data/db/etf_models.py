...
from investment_studio_instrument_core.listing_contract import SUPPORTED_LISTING_EXCHANGES

from studio_data.db.base import Base


class FmpEtfCatalog(Base):
    __tablename__ = "fmp_etf_catalog"
    __table_args__ = (
        CheckConstraint(
            "exchange_code IN ("
        ...
        Index("ix_fmp_etf_catalog_company_name", "company_name"),
        Index("ix_fmp_etf_catalog_exchange", "exchange_code"),
    )
