...
from app.db.models.read_models import AssetChartReadModel, WatchlistRowReadModel
from app.db.models.watchlists import InstrumentAttributeValue, WatchlistView
...
def build_watchlist_row_materialization(
    *,
    ...
    payload["asset_name"] = payload.get("asset_name") or display_name or asset_id.upper()
    payload["share_class"] = payload.get("share_class") or share_class
    payload["ticker_or_isin"] = payload.get("ticker_or_isin") or ticker_or_isin
    payload["management_firm_name"] = (
        payload.get("management_firm_name") or management_firm_name
    )
    payload["category_name"] = payload.get("category_name") or category_name
