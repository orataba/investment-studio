...
FIELD_CATEGORIES = [
    ...
    {
        "category_code": "product_classification",
...
INSTRUMENT_ATTRIBUTE_DEFINITIONS = [
    {
        ...
        "domain_code": "classification",
        "group_code": "taxonomy_identity",
        "display_order": 10,
        "asset_scope_json": ["fund"],
        "applicability_json": {},
        "rubric_json": {
            "summary": "先判定产品制度属性，再进入后续分类。",
            "standard": "一个基金只能有一个当前有效的基金属性。",
            "review_cycle": "仅在法律/注册形态变化时更新。",
        },
    ...
    },
    {
        ...
        "label": "产品形态",
        "description": "ETF、场外开放式、私募契约型等载体形态。",
        "data_type": "single_select",
        "options": [
            "ETF",
            "LOF/场内开放式",
        ...
        "applicability_json": {},
        "rubric_json": {
            "summary": "描述基金法律/交易载体，不等于策略分类。",
            "standard": "按当前主载体单选；不要把策略判断写进载体字段。",
        },
        "required_for_monitoring": True,
    },
    {
        "attribute_key": "fund_category_l1",
        "label": "一级分类",
        "description": "基金的第一层业务分类，用来先缩小产品池。",
        "data_type": "single_select",
        "options": [
            "主动权益",
            "指数工具",
        ...
        "default_visible": True,
        "domain_code": "classification",
        "group_code": "taxonomy_path",
        "display_order": 30,
        "asset_scope_json": ["fund"],
        "applicability_json": {},
        "rubric_json": {
            "summary": "一级分类定义基金所处的大池子，是 watchlist 初筛入口。",
            "standard": "优先按产品长期主身份归类，不因短期风格漂移改写。",
        },
        "required_for_monitoring": True,
    },
    {
        "attribute_key": "fund_category_l2",
        "label": "二级分类",
        "description": "第二层策略簇，用来区分同一大类里的主方法论。",
        "data_type": "single_select",
        "options": [
            "主动股票",
            "偏股混合",
        ...
        "applicability_json": {},
        "rubric_json": {
            "summary": "二级分类回答“这类基金主要靠什么方法做收益”。",
            "standard": "按主方法论单选；不要把风格、标签或观点混进来。",
        },
        "required_for_monitoring": True,
    },
    {
        "attribute_key": "fund_category_l3",
        "label": "三级分类",
        "description": "更细的叶子分类，用来区分同类里的具体策略分支。",
        "data_type": "single_select",
        "options": [
            "深度价值",
            "均衡成长",
        ...
        "applicability_json": {},
        "rubric_json": {
            "summary": "三级分类把产品放到真正可比较的叶子池子里。",
            "standard": "优先选最稳定、最能解释比较口径的叶子分类。",
        },
        "required_for_monitoring": True,
    },
    {
    ...
    },
    {
        ...
        "asset_scope_json": ["fund"],
        "applicability_json": {
            "fund_category_l1": ["主动权益", "指数工具", "固定收益", "固收+", "多资产", "股票", "债券"]
        },
        "rubric_json": {
