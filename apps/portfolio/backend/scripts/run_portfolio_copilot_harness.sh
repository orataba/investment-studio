...
copilot_env_root="${PORTFOLIO_OPS_SECRET_ROOT:-$HOME/.config/orataba/secrets/portfolio-operations-workbench}"
copilot_env_file="${PORTFOLIO_OPS_PORTFOLIO_COPILOT_ENV_FILE:-$copilot_env_root/portfolio-copilot.env}"
copilot_patch="$copilot_project_root/apps/portfolio/backend/config/portfolio_copilot_deepseek_harness.patch.yml"
copilot_pnpm="${PORTFOLIO_OPS_PORTFOLIO_COPILOT_PNPM:-$(command -v pnpm || true)}"
copilot_dsh_home="${PORTFOLIO_OPS_PORTFOLIO_COPILOT_DSH_HOME:-$HOME/.local/share/portfolio-operations-workbench/deepseek-harness}"
...
portfolio_ops_reject_repository_env_files "$copilot_project_root"
portfolio_ops_load_env_file \
  "$copilot_env_file" \
  DEEPSEEK_ \
  PORTFOLIO_OPS_PORTFOLIO_COPILOT_
...
export PORTFOLIO_OPS_PORTFOLIO_COPILOT_PORTFOLIO_ID="$copilot_portfolio_id"
export PORTFOLIO_OPS_PORTFOLIO_COPILOT_BATCH_ID="$copilot_batch_id"
export PORTFOLIO_OPS_PORTFOLIO_COPILOT_MODEL_NAME="deepseek-v4-flash-vision-exp"
...
copilot_exec_env=(
  ...
  "PORTFOLIO_OPS_PORTFOLIO_COPILOT_API_BASE_URL=${PORTFOLIO_OPS_PORTFOLIO_COPILOT_API_BASE_URL:-http://127.0.0.1:8001/api}"
  "PORTFOLIO_OPS_PORTFOLIO_COPILOT_PORTFOLIO_ID=$PORTFOLIO_OPS_PORTFOLIO_COPILOT_PORTFOLIO_ID"
  "PORTFOLIO_OPS_PORTFOLIO_COPILOT_BATCH_ID=$PORTFOLIO_OPS_PORTFOLIO_COPILOT_BATCH_ID"
  "PORTFOLIO_OPS_PORTFOLIO_COPILOT_MODEL_NAME=$PORTFOLIO_OPS_PORTFOLIO_COPILOT_MODEL_NAME"
)
