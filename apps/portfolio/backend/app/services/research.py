...
from app.services.asset_charts import build_asset_sparkline
from app.services.instrument_registry import InstrumentRegistryError
from app.services.ledger import build_account_workspace
from app.services.performance import build_statement_of_assets_report
from app.services.research_backtest import build_research_scope_options, run_taxonomy_backtest
    ...
    *,
    ...
    signals = [
        ...
        },
        {
            ...
            "value": str(settings_payload.get("target_dimension") or "scope_default").replace("_", " ").title(),
            "tone": "neutral",
        },
        {
            "label": "Rebalance",
    ...
    return {
        ...
        "rebalance_events": deepcopy(backtest.get("rebalance_events") or []),
