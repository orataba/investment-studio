...
from app.api.assemblers import serialize_transaction, summarize_transactions
...
from app.services.portfolio_store import create_account, get_account, get_portfolio, list_accounts, list_transactions
...
def get_accounts_workspace(
    ...
    linked_transactions_raw = (
        list_transactions(portfolio_id, account_id=selected_account_id) if selected_account_id else []
    )
