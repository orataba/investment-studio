...
WORK_DIR="$(mktemp -d "${TMPDIR:-/tmp}/investment-studio-log-compaction.XXXXXX")"
...
INVESTMENT_STUDIO_LOCAL_LOG_MAX_BYTES=10 \
INVESTMENT_STUDIO_LOCAL_LOG_RETAIN_BYTES=6 \
